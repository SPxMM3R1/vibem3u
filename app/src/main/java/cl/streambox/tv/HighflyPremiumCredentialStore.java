...
public final class HighflyPremiumCredentialStore {
    ...
    private byte[][] encrypt(String token) throws GeneralSecurityException {
        ...
        // Android Keystore requires randomized encryption to use an IV
        // generated by the cipher. Supplying an app-generated IV is rejected
        // by API 29+ providers with "Caller-provided IV not permitted".
